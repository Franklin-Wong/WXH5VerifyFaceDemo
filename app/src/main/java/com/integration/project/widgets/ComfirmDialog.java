...
public class ComfirmDialog {
    ...
    public static void showComfirmDialog(Activity activity, final OnUnbindDialogListener dialogListener) {
        //弱引用
        ...
        if (c != null) {
            ...
            View layout = LayoutInflater.from(c).inflate(R.layout.comfirm_view, null, false);
            ...
            final TextView cancel = layout.findViewById(R.id.tvCancel);
